...
<?php include (TEMPLATEPATH . '/funcoes.php'); ?>
<?php get_header();?>
<?php 
    // MOSTRAR A CATEGORIA 
...
<section class="conteudo">
    <div class="container">
        <div class="conteudo-categoria c700x1 pull-left">
            <header>
                <h1 class="text-transform-upper">Últimas notícias de <?=getMes(date('m'))?>/<?=date('Y')?></h1>
            </header>
            ...
            <div id="paginacao"><?php wp_reset_query(); wp_pagenavi(); ?></div>
            ...
            <div class="container-conteudo-auxiliar c340x1 pull-left">
                <section class="publicidade-artigo pull-left c300x1">
                    ...
                    <div class="blc-publicidade">
                        <?php drawAdsPlace(array('id' => 7), false); ?>
                    </div>
                </section>
                ...
                <section class="face-artigo pull-left c300x1 margin-top-20 margin-bottom-10" style="margin-top:20px !important">
                    <div id="fb-root"></div>
